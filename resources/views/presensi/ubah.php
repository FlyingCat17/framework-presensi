                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-right font-weight-bold" style="margin-top: -10px;"><?= $data['id_presensi'] ?></p>
                            ...
                            <form action="<?= base_url; ?>presensi/update_presensi_act" method="post">
                                <div class="form-group mt-4">
                                    <h6>Mulai Presensi</h6>
                                    <div class="row mt-3 mb-3">
                                        <div class="col-lg-6 col-sm-12">
                                            <label for="date-start">Tanggal</label>
                                            <input type="text" name="date-start" class="form-control bg-white date-local" value="<?= $data['presensi']->date_mulai ?>" style="border: 1px solid #C9C9C9;">
                                            <input type="hidden" name="id_jadwal" value="<?= $data['jadwal']->id_jadwal ?>">
                                            <input type="hidden" name="id_presensi" value="<?= $data['id_presensi'] ?>">
                                        </div>
                                        <div class="col-lg-6 col-sm-12">
                                            <label for="time-start">Jam</label>
                                            <input type="text" name="time-start" value="<?= $data['presensi']->mulai ?>" class="form-control bg-white time-local" style="border: 1px solid #C9C9C9;">
                                        </div>
                                    </div>
                                </div>
                                <hr>
                                <div class="form-group mt-4">
                                    ...
                                    <div class="row mt-3 mb-3">
                                        <div class="col-lg-6 col-sm-12">
                                            <label for="date-start">Tanggal</label>
                                            <input type="text" name="date-end" class="form-control bg-white date-local" value="<?= $data['presensi']->date_akhir ?>" style="border: 1px solid #C9C9C9;">
                                        </div>
                                        <div class="col-lg-6 col-sm-12">
                                            <label for="time-start">Jam</label>
                                            <input type="text" name="time-end" value="<?= $data['presensi']->akhir ?>" class="form-control bg-white time-local" style="border: 1px solid #C9C9C9;">
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex justify-content-end align-items-end">
                                    <a href="<?= base_url; ?>presensi/detail/<?= $data['jadwal']->id_jadwal ?>" class="btn btn-danger mt-3 mr-3">Kembali</a>
