                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-right font-weight-bold" style="margin-top: -10px;"><?= $data['jadwal']->id_jadwal ?></p>
                            ...
                            <form action="<?= base_url; ?>presensi/<?= $data['jadwal']->id_jadwal ?>/tambah"
                                method="post">
                                <div class="form-group mt-4">
                                    ...
                                    <div class="row mt-3 mb-3">
                                        ...
                                        <div class="col-lg-6 col-sm-12">
                                            ...
                                            <input type="text" name="time_end"
                                                value=" <?= $data['jadwal']->jam_akhir_convert ?>"
                                                class="form-control bg-white time-local"
                                                style="border: 1px solid #C9C9C9;">
                                        </div>
                                    </div>
                                ...
                                <div class="d-flex justify-content-end align-items-end">
                                    <button type="button"
                                        onclick="location.href='<?= base_url; ?>presensi/<?= $data['jadwal']->id_jadwal ?>'"
                                        class="btn btn-danger mt-3 mr-3">Kembali</button>
