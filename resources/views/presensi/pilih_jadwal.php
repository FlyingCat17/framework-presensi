            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <button type="button"
                                onclick="location.href='<?= base_url; ?>jadwal/kelas/<?= $data['jadwal']->id_kelas_ajaran ?>/tambah'"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-success align-items-center m-1"
                                                        ...
                                                        data-id="<?= $jadwal['id_jadwal'] ?>" style="width: 20px;"><i
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        class="btn btn-warning edit_jadwal m-1" data-toggle="tooltip"
                                                        data-placement="top" title="Ubah Jadwal" style="width: 30px;"
                                                        data-id="<?= $jadwal['id_jadwal'] ?>"><i class="far fa-edit"
                                                            style="margin-left: -5px;"></i></button>
                                                    <button class="btn btn-danger m-1 tampilModalHapus"
                                                        data-toggle="modal" data-target="#hapus_jadwal"
                                                        ...
                                                        style="width: 30px;"><i class="far fa-trash-alt"
                                                            style="margin-left: -5px;"></i></button>
                                                </td>
                                            </tr>
                                            <?php
...
<div class="modal fade" id="hapus_jadwal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url; ?>jadwal/delete" method="POST" id="form_hapus">
                <div class="modal-body">
                    ...
                    <div class="alert alert-danger">
                        <strong>PERHATIAN! </strong>JIka menghapus jadwal ini, maka seluruh presensi yang ada pada
                        jadwal ini akan
                        otomatis terhapus!
                    </div>
                </div>
