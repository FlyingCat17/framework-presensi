...
<body>
    <div class="app">
        <div class="container-fluid p-h-0 p-v-20 bg full-height d-flex"
            style="background-image: url('<?= base_url ?>resources/images/bg-login-1.png')">
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center justify-content-center mb-3">
                                        <img class="img-fluid" alt=""
                                            src="<?= base_url ?>resources/img/logo/new_logo/logo.png" width="190">
                                    </div>
                                    <h2 class="font-weight-bold text-center mb-2">LOGIN PAGE</h2>
                                    <form action="login" method="post" method="POST">
                                        <div class="form-group">
                                            <label class="font-weight-semibold" for="userName">Username / NUPTK:</label>
                                            <div class="input-affix">
                                                <i class="prefix-icon anticon anticon-user"></i>
                                                <input type="text" class="form-control" id="userName" name="username"
                                                    placeholder="Username / NUPTK">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="d-flex align-items-center">
                                                <button class="btn w-100 text-white" style="background-color: #48CD18;"
