							...
							<div class="row">
								<div class="col-lg-10 col-md-12 my-2 ">
									<div class="form-group">
										<input type="text" style="width: 100%;" class="form-control"
											id="formGroupExampleInput" placeholder="Cari Siswa">
									</div>
								</div>
								...
								<div class="col-lg-1 col-md-12 my-2">
									<button type="button" class="btn btn-icon btn-primary"
										onclick="location.href = '<?= base_url; ?>siswa/tambah';" style="width: 100%;">
											...
											<tr>
												...
												<td>
													<button type="button" data-nis="<?= $siswa['nis'] ?>"
														class="btn btn-icon btn-warning" id="btn-ubah-siswa"
														onclick="location.href='<?= base_url; ?>siswa/ubah/<?= $siswa['nis'] ?>'">
														<i class="anticon anticon-edit"></i>
													</button>
													<button type="button" data-nis="<?= $siswa['nis'] ?>"
														data-nama="<?= $siswa['nama_siswa'] ?>"
														class="btn btn-icon btn-danger tampilModalHapus"
														data-toggle="modal" data-target="#model_hapus_siswa">
