        ...
        <div class="container">
            <div class="row d-flex justify-content-center">
                <div class="col-md-12 col-lg-6">
                    <div>
                        <h2 class="mb-4 font-weight-bold">Ubah Guru</h2>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <div>
                                        ...
                                        $guru = $data['guru'];
                                        ?>
                                        <form action="<?= base_url; ?>guru/ubah/<?= $guru->nuptk; ?>" method="post">
                                            <div class="input-group mb-4">
                                                ...
                                                <input type="text" name="nuptk" id="nuptk" class="form-control"
                                                    ...
                                                    aria-describedby="basic-addon1" value="<?= $guru->nuptk; ?>"
                                                    required>
                                            </div>
                                            <div class="input-group mb-4">
                                                <div class="input-group-prepend">
                                                ...
                                                <input type="text" name="nama" id="nama" class="form-control"
                                                    ...
                                                    aria-describedby="basic-addon1" value="<?= $guru->nama_guru; ?>"
                                                    required>
                                            </div>
                                            <div class="input-group mb-4">
                                                <div class="input-group-prepend">
                                                ...
                                                <input type="text" name="tempat_lahir" id="tempat_lahir"
                                                    ...
                                                    aria-label="Tempat Lahir" aria-describedby="basic-addon1"
                                            ...
                                            <div class="input-group mb-4">
                                                ...
                                                <input type="text" name="alamat" id="alamat" class="form-control"
                                                    ...
                                                    value="<?= $guru->alamat_guru?>" required>
                                            </div>
                                            ...
                                            <div class="input-group mb-4">
                                                ...
                                                <input type="text" name="telepon" id="telepon" class="form-control"
                                                    ...
                                                    aria-describedby="basic-addon1"
                                                    value="<?= $guru->notelp_guru?>" required>
                                            </div>
                                            <div class="input-group mb-4">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="basic-addon1"><i
                                                ...
                                                <input type="text" name="status" id="status" class="form-control"
                                                    ...
                                                    aria-describedby="basic-addon1"
                                                    value="<?= $guru->status_kepegawaian?>" required>
                                            </div>
